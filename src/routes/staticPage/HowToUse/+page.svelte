...
<PageContainer title="참여방법">
    ...
    <div class="row gx-0 gy-3 mt-0 mb-5 mx-1" transition:fly={{ y: 20, duration: 400 }}>
        ...
        <div class="col-12">
            ...
            <div class="row gx-0 gy-2">
                <div class="col-12">
                    ...
                    <p class="ps-4">예배 출석, 교사 헌신 등 중직자팀에서 파악해 달란트를 반영할 수 있는 것은 자동 반영을 합니다. 혹시 누락된 것이 있다면 개인이 문의해야 하며 문의하지 않아 반영되지 못한 것은 개인 과실로 중직자팀의 책임이 아닙니다.</p>
                    <p class="ps-4 mt-1 small text-secondary text-pretty">지급 내역은 [메뉴 → 홈 → 내 달란트 지급내역] 에서 확인할 수 있습니다.</p>
                </div>
                <div class="col-12">
                    <p class="ps-2">2) 개인 인증 반영</p>
                    <p class="ps-4">수련회, 전도학교, 지교회 등 개인 인증 반영 훈련들은 본인 얼굴이 포함된 단체 사진, 개인 셀카를 제출하는 것을 원칙으로 하며 제출 가능한 사진이 없을 시 각 훈련 담당 교역자의 사인을 받아 제출해 개인 인증하도록 합니다. 역시 누락된 것이 있다면 개인이 문의해야 하며 문의하지 않아 반영되지 못한 것은 개인 과실로 중직자팀의 책임이 아닙니다.</p>
                </div>
                <div class="col-12">
                    <p class="ps-4 mt-1 text-pretty"><b>* 달란트 지급 기간</b> : 중직자PASS타임 일주일 전 자정까지 획득 달란트가 반영됩니다.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="row gx-0 gy-1">
                <div class="col-12">
                    <p class="ps-2">1) 300 달란트 이상 획득.</p>
                </div>
                <div class="col-12">
                    <p class="ps-2">2) 청년국 예배 참석 항목에서 획득 가능한 달란트의 2/3인 64 달란트 이상 획득.</p>
                </div>
                <div class="col-12">
                    <p class="ps-2">3) 중직자가 받을 축복 카테고리 5가지 중 모든 카테고리에서 2달란트 이상 획득.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="row gx-0 gy-2">
                <div class="col-12">
                    <p class="ps-2">1) 80 달란트 획득 시 도서 증정</p>
                    <p class="ps-4">☞ 세상 살리는 지혜를 위한 추천 도서(담임목사님, 담당교역자, 국장님, 부국장님 중 랜덤)가 간단한 축하 문구와 함께 증정됩니다.</p>
                </div>
                <div class="col-12">
                    <p class="ps-2">2) 180 달란트 획득 시 신발 증정</p>
                    <p class="ps-4">☞ 세계복음화를 위해 성실하게 뛸 신발(5만원 상당의 신발 구매금액 지원)이 증정됩니다.</p>
                </div>
                <div class="col-12">
                    <p class="ps-2">3) 300 달란트 획득 시 중직자PASS 수료패 증정, 청년국 단기선교 참가비 일부 지원</p>
                    <p class="ps-4">☞ 중직자PASS 훈련 프로그램의 최종 목표인 300 달란트 달성 시 ‘중직자PASS 수료패’ 증정과 세계복음화를 가장 잘 느끼며 마음 담을 수 있는 ‘청년국 단기선교 참가비’ 일부(30만원)를 지원합니다.</p>
                </div>
            </div>
        </div>
